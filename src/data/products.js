export const products = [
  ...
  },
  {
    ...
    image: "https://github.com/user-attachments/assets/86c78b74-bd8f-40e7-83d8-19269c3920e5",
    description: "A dreamy, carefree floral that captures the spirit of the free-spirited woman. Light, feminine, and irresistibly romantic — a true daisy dream.",
    scentNotes: { top: "Cloudberry, Grapefruit, White Florals", middle: "Daisy Tree Petals, Magnolia", base: "Driftwood, Cashmere Musk, Vanilla" },
    rating: 4.8,
    reviews: 1365,
    isFeatured: true,
    isBestSeller: true,
